...
namespace NightDuty
{
    ...
    /// </para>
    /// <para>
    /// 구간 폭은 균일하지 않다: Band0=0~23, Band1=24~47, Band2=48~71,
    /// Band3=72~89(18칸), Band4=90~99(10칸). 100은 종료 잠금이다.
    /// (2026-09-21 밸런스 재설계로 경계를 24의 배수에 맞춘 결과다. 범위의 단일 출처는 <see cref="Bands"/>다.)
    /// </para>
    /// <para>
    /// 등 개수의 기획 확정값:
